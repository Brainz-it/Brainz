...
window.WEDDING_THEME = (function () {
  ...
  function build(c, h) {
    ...
    var html = ''
      ...
      + '  <div class="t10-place-block"><div class="t10-kicker">' + esc(ve.ceremonyLabel) + '</div><h3>' + esc(ve.ceremonyName) + '</h3><p>' + esc(ve.ceremonyTime) + ' · ' + esc(ve.ceremonyAddress) + '</p><a class="t10-link" target="_blank" rel="noopener" href="' + esc(ve.mapsUrl || maps(ve.ceremonyName + " " + ve.ceremonyAddress)) + '">' + esc(ve.mapsLabel) + '</a></div>'
      + '  <div class="t10-place-block"><div class="t10-kicker">' + esc(ve.receptionLabel) + '</div><h3>' + esc(ve.receptionName) + '</h3><p>' + esc(ve.receptionTime) + ' · ' + esc(ve.receptionAddress) + '</p><a class="t10-link" target="_blank" rel="noopener" href="' + esc(ve.mapsUrl || maps(ve.receptionName + " " + ve.receptionAddress)) + '">' + esc(ve.mapsLabel) + '</a></div>'
